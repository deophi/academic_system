...
<head>
  ...
  <title>Jadwal Pelajaran Kelas {{ $kls->kelas->nama }}</title>
...
<body>
  <div class="container">
    <div class="judul">
      ...
      Daftar Pelajaran Kelas {{ $kls->kelas->nama }}
    </div>
    <br>
    <div class="ket">
      Wali Kelas: {{ $kls->kelas->wali->name }}<br>
      Tahun Ajar: {{ $kls->kelas->angkatans->tahun }}
    </div>
    <br>
