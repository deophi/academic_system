...
@elseif(Auth::user()->levels_id < 8)
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form action="{{ route('surattugas.edit', $srt->id) }}" method="get">
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      <small style="color: red;">Klasifikasi sebelumnya adalah {{ $srt->surats->suratds_id }} - {{ $srt->surats->suratds->nama }}</small>
                    </div>
                    <div class="form-group col-6">
