                    ...
                    <div class="card-header-action">
                      <div class="dropdown dropleft">
                        ...
                        <div class="dropdown-menu dropleft">
                          @foreach($gol as $r)
                            <a class="dropdown-item" href="{{ route('gurupnsgol', $r->id) }}">{{ $r->nama }}</a>
                          @endforeach
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      ...
                      <table class="table table-sm table-striped">
                        <tr>
                        @if($pnsyes->isEmpty())
                          <td><div class="alert alert-info alert-dismissible show fade" align="center"><div class="alert-body">Guru PNS tidak ada.</div></div></td>
                        </tr>
                        @else
                          <th>NIP</th>
                          <th>Nama</th>
